...
void main() {
  group('Hlc', () {
    ...
    test('toString formats correctly', () {
      final hlc = Hlc(1000, 5, 'node1');
      expect(hlc.toString(), '1000:0005:node1');
    });

    test('comparison logic', () {
      final t1 = Hlc(1000, 0, 'a');
      final t2 = Hlc(1000, 1, 'a');
      final t3 = Hlc(1001, 0, 'a');
      final t4 = Hlc(1000, 0, 'b');
    ...
    test('receive (remote event)', () {
      ...
      final res2 = local.receive(Hlc(1100, 5, 'remote'), 1010);
      ...
      // Result: 1000:6
      final res3 = local.receive(Hlc(1000, 5, 'remote'), 1000);
