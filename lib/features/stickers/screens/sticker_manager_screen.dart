...
class StickerManagerScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return const Scaffold(
      appBar: _StickerManagerAppBar(),
      body: StickerManagerView(),
    );
  }
}

class _StickerManagerAppBar extends StatelessWidget
    implements PreferredSizeWidget {
  const _StickerManagerAppBar();
...
class StickerManagerView extends ConsumerWidget {
  const StickerManagerView({super.key});
