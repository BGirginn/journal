        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              title: Text(l10n.editorMediaImage),
              subtitle: Text(l10n.editorMediaImageSubtitle),
              onTap: () {
            ...
            ListTile(
              ...
              title: Text(l10n.editorMediaVideo),
              subtitle: Text(l10n.editorMediaVideoSubtitle),
              onTap: () {
                Navigator.pop(context);
                _addVideoBlock();
              },
            ...
            ListTile(
              ...
              title: Text(l10n.editorMediaAudio),
              subtitle: Text(l10n.editorMediaAudioSubtitle),
              onTap: () {
                Navigator.pop(context);
                _recordAudio();
              },
            ...
            ListTile(
              ...
              title: Text(l10n.editorMediaDrawing),
              subtitle: Text(l10n.editorMediaDrawingSubtitle),
              onTap: () {
                Navigator.pop(context);
                _openDrawingCanvas();
              },
